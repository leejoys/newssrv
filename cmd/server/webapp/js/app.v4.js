(function(e) {
    function t(t) {
        for (var r, u, i = t[0], c = t[1], l = t[2], f = 0, p = []; f < i.length; f++) u = i[f], Object.prototype.hasOwnProperty.call(a, u) && a[u] && p.push(a[u][0]), a[u] = 0;
    ...
    u.m = e, u.c = r, u.d = function(e, t, n) { u.o(e, t) || Object.defineProperty(e, t, { enumerable: !0, get: n }) }, u.r = function(e) { "undefined" !== typeof Symbol && Symbol.toStringTag && Object.defineProperty(e, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e, "__esModule", { value: !0 }) }, u.t = function(e, t) {
        ...
        return n
    }, u.n = function(e) { var t = e && e.__esModule ? function() { return e["default"] } : function() { return e }; return u.d(t, "a", t), t }, u.o = function(e, t) { return Object.prototype.hasOwnProperty.call(e, t) }, u.p = "/";
        ...
        var r = n("2b0e"),
            ...
            u = function() {
                var e = this,
                    t = e.$createElement,
                    n = e._self._c || t;
                return n("div", [n("h2", { staticClass: "mx-5 my-5" }, [e._v("GoNews - агрегатор новостей.")]), e._l(e.news, (function(t) { return n("div", { key: t.ID }, [n("v-card", { staticClass: "mx-5 my-5", attrs: { elevation: "10", outlined: "" } }, [n("v-card-title", [n("a", { attrs: { href: t.Link, target: "_blank" } }, [e._v(" " + e._s(t.Title) + " ")])]), n("v-card-text", [e._v(" " + e._s(t.Content) + " "), n("v-card-subtitle", [e._v(" " + e._s(new Date(1e3 * t.PubTime)) + " ")])], 1)], 1)], 1) }))], 2)
            },
            i = [],
            c = (n("d3b7"), {
                name: "News",
            ...
            h = b.exports;
        p()(b, { VCard: d["a"], VCardSubtitle: v["a"], VCardText: v["b"], VCardTitle: v["c"] });
        var w = { name: "App", components: { News: h }, data: function() { return {} } },
            y = w,
            m = n("7496"),
            _ = n("f6c4"),
